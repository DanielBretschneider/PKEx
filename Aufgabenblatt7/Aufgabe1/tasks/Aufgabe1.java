...
public class Aufgabe1 {
    ...
    public static Person createHubert() {
        ArrayList<Person> hubertKinder = new ArrayList<Person>();
        ArrayList<Person> gernotkinder = new ArrayList<Person>();

        /* Gernot & kids */
        Person roman = new Person("Roman", "Mueller", "maennlich", 12, 1116, new ArrayList<Person>());
        Person sophie = new Person("Sophie", "Mueller", "weiblich", 14, 1117, new ArrayList<Person>());
        gernotkinder.add(roman);
        gernotkinder.add(sophie);

        /* Hubert & kids */
        hubertKinder.add(createJulia());
        hubertKinder.add(new Person("Gernot", "Mueller", "maennlich", 40, 1115 , gernotkinder));

        /* Hubert itself */
        Person hubert = new Person("Hubert", "Maier", "maennlich", 88, 1324, hubertKinder);
        return hubert;
    }
    
    public static Person createJulia() {
        /* julias kids */
        ArrayList<Person> juliaKinder = new ArrayList<Person>();
        juliaKinder.add(createThomas());
        juliaKinder.add(new Person("Gernot", "Maier", "maennlich", 24, 3333, new ArrayList<Person>()));

        Person julia = new Person("Julia", "Maier", "weiblich", 54, 1111, juliaKinder);
        return julia;
    }
    
    public static Person createThomas() {
        Person thomas = new Person("Thomas", "Maier", "maennlich", 22, 2222, new ArrayList<Person>());
        return thomas;
    }
